...
class PaneCarousel {
  ...
  checkAttachedPanes () {
    if (this.popWindowOne.childNodes[0]) {
      let childNodes = this.popWindowOne.childNodes.length;
...
class ScriptsModel {
  ...
  /**
   *
   * @return {object} Template literal stored in the 
...
/**
 *
 * @overview - main arrow function instantiates our class
